...
def cmd_status():
    ...
    print(f"Auto-Transfer to Preferred Bank / Any Bank: ENABLED (Daily Auto-Sweep Active)")
    print(f"PayPal Balance: ${reflect['balance_usd']:.2f} USD (Auto-transferred to Preferred Bank / Any Bank)")
    ...
    print(" - Primary Settlement: Preferred Bank / Any Bank (Auto-Sweep ACTIVE)")
